...
```mermaid
graph TD
  36187e84["ERC-721 NFT"]
  43cdf920["Frontend"]
  b7c0bb57["Wallet Auth"]
  36187e84 --> 43cdf920
  43cdf920 --> b7c0bb57
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--36187e84.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--43cdf920.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--b7c0bb57.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--36187e84.md)
- [Frontend](.nskills/components/frontend-scaffold--43cdf920.md)
- [Wallet Auth](.nskills/components/wallet-auth--b7c0bb57.md)
